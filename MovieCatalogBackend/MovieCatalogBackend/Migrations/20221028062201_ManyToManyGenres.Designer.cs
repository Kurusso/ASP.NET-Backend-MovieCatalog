...
namespace MovieCatalogBackend.Migrations
{
    ...
    [Migration("20221028062201_ManyToManyGenres")]
    partial class ManyToManyGenres
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MovieCatalogBackend.Models.GenreDbModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MovieCatalogBackend.Models.MovieGenreDbModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MovieCatalogBackend.Models.MovieGenreDbModel", b =>
                {
                    b.HasOne("MovieCatalogBackend.Models.GenreDbModel", "Genre")
                        .WithMany("Movies")
